...
public static class LocalizationService
{
    ...
    private static Dictionary<string, string> BuildLiteralMap()
    {
        ...
        Add(map, "Machines", "Devices");
        Add(map, "Source de modèles", "Template source");
        Add(map, "Source de la banque de machines", "Device bank source");
        Add(map, "Ajouter depuis la banque", "Add from bank");
        Add(map, "Gérer la banque", "Manage bank");
        Add(map, "Chargement des banques de machines...", "Loading device banks...");
        Add(map, "Choisissez une banque puis ajoutez une nouvelle machine indépendante au projet.", "Choose a bank, then add a new independent device to the project.");
        Add(map, "Ouvre la banque sélectionnée pour rechercher, modifier, importer ou exporter des modèles.", "Opens the selected bank to search, edit, import, or export templates.");
        Add(map, "Votre banque active et les banques fournies restent séparées. Choisissez ici celle à consulter.", "Your active bank and the included banks remain separate. Choose which one to browse here.");
        Add(map, "Synoptique", "Synoptic");
        Add(map, "Centre de validation", "Validation center");
        Add(map, "Historique", "History");
        Add(map, "Outils avancés", "Advanced tools");

...
public static class LocalizationService
{
    private static readonly Dictionary<string, string> French = new(StringComparer.Ordinal)
    {
        ...
        ["Dialog.MergeXmlWarning"] = "Les machines du fichier XML sélectionné seront ajoutées au projet courant. Une identité technique déjà présente sera réutilisée ; aucun faux device_id ne sera créé. Continuer ?",
        ["DuplicateDialog.Title"] = "Doublons de machines",
        ["DuplicateDialog.Intro"] = "Certaines machines du XML importé existent déjà. « Importer uniques seulement » réutilise un rôle portant la même identité technique. Renommer un tel doublon crée un rôle hors ligne indépendant sans recopier son device_id, afin de pouvoir l'affecter ensuite à une autre machine compatible dans Dante Controller.",
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["Dialog.MergeXmlWarning"] = "Devices from the selected XML file will be added to the current project. An existing technical identity will be reused; no fake device_id will be created. Continue?",
        ["DuplicateDialog.Title"] = "Duplicate devices",
        ["DuplicateDialog.Intro"] = "Some devices from the imported XML already exist. “Import unique only” reuses a role with the same technical identity. Renaming such a duplicate creates an independent offline role without copying its device_id, so it can later be assigned to another compatible device in Dante Controller.",

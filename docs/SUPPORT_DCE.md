...
- n'apparaît pas au premier lancement ;
- ne s'affiche qu'après 20 lancements réussis ;
- peut être reporté de 20 lancements ;
- peut être désactivé définitivement ;
- reste enregistré uniquement sur l'ordinateur.
...
- does not appear on first launch;
- appears only after 20 successful launches;
- can be postponed for another 20 launches;
- can be disabled permanently;
- is stored only on the computer.

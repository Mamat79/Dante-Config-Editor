    ...
    if french:
        ...
        page2 = [
            ...
            *bullets([
                ...
                "Ajouter depuis la banque et Gérer les banques ouvrent directement la liste globale dédupliquée de 45 modèles avec leur origine. La banque personnelle et les banques fournies restent séparées.",
            ]),
        ...
        screen_map = [
            ...
            data_table(
                ...
                [
                    ...
                    ["Patch > Matrice", "Grille RX/TX, navigation des liaisons, fenêtre détachée, glissement, 1:1, zoom et renommage."],
        ...
        easy_patch_workflows = [
            ...
            *bullets([
                ...
                "Le bouton d'une ligne RX retrouve sa source TX, sélectionne la machine émettrice et surligne le croisement.",
                "Le bouton sous un en-tête TX liste toutes ses destinations RX. Choisissez-en une pour afficher et surligner son croisement.",
                "Détacher la matrice ouvre une grande fenêtre qui conserve les sélecteurs RX/TX, FLIP, PATCH 1:1 et le zoom.",
        ...
        bank_workflow_page = [
            ...
            data_table(
                ...
                [
                    ...
                    ["Parcourir les banques", "Machines > Gérer les banques ouvre les 45 modèles sans doublon. Le filtre Banques affichées isole la banque personnelle ou une banque fournie, et la colonne Banque indique l'origine."],
                    ...
                    ["Ajouter au projet", "Sélectionner le modèle > Ajouter au projet > choisir le premier nom, la quantité (1 par défaut) et les labels > vérifier l'aperçu > confirmer. Pour un lot, DCE crée Nom, Nom-2, Nom-3, etc., valide tout avant insertion et garde la banque ouverte."],
                ],
                [48, 122],
            ),
            Spacer(1, 3 * mm),
            *bullets([
                ...
                "Les 45 modèles GitHub fournis sont assainis et installés avec l'application ; une banque personnelle n'est jamais remplacée.",
            ]),
        ...
        page2 = [
            ...
            *bullets([
                ...
                "Add from bank and Manage banks directly open the global deduplicated list of 45 templates with their source. The personal and bundled banks remain separate.",
            ]),
        ...
        bank_workflow_page = [
            ...
            data_table(
                ...
                [
                    ...
                    ["Browse banks", "Devices > Manage banks opens all 45 templates without duplicates. The Displayed banks filter isolates the personal or a bundled bank, while the Bank column shows its source."],
            ...
            *bullets([
                ...
                "The 45 bundled GitHub templates are sanitized and installed with the application; a personal bank is never replaced.",
            ]),

    ...
    if french:
        page1 = [
            ...
            *bullets([
                ...
                "L'assistant propose le dossier de banque actif et le dossier des banques fournies. Les banques DCE Generic Roles 3.6 et Yamaha QL1 + Fohhn DI4.1000 sont facultatives, sélectionnables séparément et aucun dossier existant n'est remplacé.",
        ...
        bank_page = [
            ...
            *bullets([
                ...
                "Banques GitHub ouvre le catalogue public V3.6. DCE Generic Roles 3.6 fournit deux rôles d'essai 8x8 et 32x32. La banque communautaire Yamaha QL1 + Fohhn DI4.1000 fournit deux modèles illustrés assainis. Ces banques ne contiennent ni identité matérielle, ni donnée réseau, ni abonnement.",
        ...
        page1 = [
            ...
            *bullets([
                ...
                "The wizard offers separate active-bank and included-bank folders. DCE Generic Roles 3.6 and Yamaha QL1 + Fohhn DI4.1000 are optional, can be selected independently, and no existing folder is replaced.",
        ...
        bank_page = [
            ...
            *bullets([
                ...
                "GitHub banks opens the public V3.6 catalog. DCE Generic Roles 3.6 provides generic 8x8 and 32x32 test roles. The Yamaha QL1 + Fohhn DI4.1000 community bank provides two sanitized illustrated templates. These banks contain no hardware identity, network data, or subscription.",

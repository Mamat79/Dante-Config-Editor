...
2027.2.3 fixes Flip in the matrix: the selected devices exchange positions,
with TX always at the top and RX on the left. Open channels stay expanded,
and trackpad pinch zooms the matrix. Previous update-check fixes remain included.

**Shared stable version: 2027.2.3 for Windows, macOS Apple Silicon, and macOS Intel.**

| Platform | Direct download |
| --- | --- |
| Windows 11 x64 | [Self-contained 2027.2.3 `.exe` installer](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/DanteConfigEditor2027_Installer.exe) |
| macOS Apple Silicon | [`.dmg` disk image](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/DanteConfigEditor2027_macOS_AppleSilicon.dmg) |
| macOS Intel | [`.dmg` disk image](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/DanteConfigEditor2027_macOS_Intel.dmg) |
| Download verification | [SHA-256 checksums](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/SHA256SUMS.txt) |
...
| --- | --- | --- |
| Short presentation | [MP4 video](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/dante-config-editor-presentation-en.mp4) | [Vidéo MP4](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/dante-config-editor-presentation-fr.mp4) |
| Windows quick start | [English PDF](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/QuickStart_DanteConfigEditorV3_EN.pdf) | [PDF français](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/QuickStart_DanteConfigEditorV3_FR.pdf) |
| Windows full manual | [English PDF](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/Notice_DanteConfigEditorV3_EN.pdf) | [PDF français](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/Notice_DanteConfigEditorV3_FR.pdf) |
| macOS quick start | [English PDF](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/QuickStart_DanteConfigEditor_macOS_EN.pdf) | [PDF français](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/QuickStart_DanteConfigEditor_macOS_FR.pdf) |
| macOS full manual | [English PDF](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/Notice_DanteConfigEditor_macOS_EN.pdf) | [PDF français](https://github.com/Mamat79/Dante-Config-Editor/releases/download/v2027.2.3/Notice_DanteConfigEditor_macOS_FR.pdf) |
...
The videos introduce the software's principles. The 2027.2.3 manuals cover
...
source/destination lookup, and device settings on double-click. Flip swaps the
selected pair, not the axes; two fingers scroll and pinch zooms around the pointer. Multicast lists
...
Version 2027.2.3 automatically adapts the interface to wide, compact, or narrow
...
The [2027.2.3 Release](https://github.com/Mamat79/Dante-Config-Editor/releases/tag/v2027.2.3)

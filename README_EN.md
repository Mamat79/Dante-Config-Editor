...
The same project can later be used with StageDesk, StageMark, StageFlow,
...
- [StageDesk — transfer between consoles and software](https://github.com/Mamat79/StageDesk/releases/latest)

...
public sealed class LocalizationConsistencyTests
{
    private static readonly HashSet<string> LanguageNeutralLiterals = new(StringComparer.Ordinal)
    {
        ...
        "0 device - 0 TX - 0 RX", "-------[]--", "ATOMIC", "Atomic Bomb", "BOMB", "By Mamat", "et ses agents", "SiLeMI/O", "Dante Config Editor", "Dante Config Editor 2026.1.1",
        "Daisychain", "Dante Config Editor 2026.1.1 - macOS", "Dante Id",
